  ...
  if (stripeEvent.type === 'checkout.session.completed') {
    ...
    try {
      ...
      if (metadata.restaurantId !== 'le-bengale') {
        console.log(`⚠️ Webhook ignoré : commande pour ${metadata.restaurantId}, pas pour le-bengale`);
        return {
          statusCode: 200,
          body: JSON.stringify({ 
            received: true, 
              ...
              <div style="padding: 30px;">
                ...
                <div style="background: #eff6ff; padding: 20px; border-radius: 8px; margin: 30px 0; border-left: 4px solid #3b82f6;">
                  <p style="margin: 0; color: #1e40af; font-size: 14px;">
                    ...
                    Contactez-nous au 03 83 37 56 70 ou répondez directement à cet email.
                  </p>
                </div>
