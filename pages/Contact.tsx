  ...
  return (
    <>
      <SEO
        ...
        description="Contactez le restaurant indien Nabab Jada à Nancy. Téléphone, adresse, horaires. Réservation en ligne disponible."
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            {mapSrc && (
              <div className="h-[500px] w-full bg-bengal-card rounded-2xl overflow-hidden shadow-2xl border-4 border-bengal-card relative group">
                <iframe width="100%" height="100%" style={{ border: 0, filter: 'grayscale(0.3) contrast(1.1) sepia(0.2)' }} loading="lazy" allowFullScreen referrerPolicy="no-referrer-when-downgrade" src={mapSrc} title="Nabab Jada sur la carte" className="group-hover:grayscale-0 transition-all duration-500"></iframe>
              </div>
            )}
          </div>
        </div>
